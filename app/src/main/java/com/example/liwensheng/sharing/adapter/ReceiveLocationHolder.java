...
import com.example.liwensheng.sharing.base.BaseViewHolder;
import com.example.liwensheng.sharing.base.ImageLoaderFactory;
...
public class ReceiveLocationHolder extends BaseViewHolder {
  ...
  public void bindData(Object o) {
    ...
    //加载头像
    ImageLoaderFactory.getLoader().loadAvator(iv_avatar,info != null ? info.getAvatar() : null, R.mipmap.default_avatar);
