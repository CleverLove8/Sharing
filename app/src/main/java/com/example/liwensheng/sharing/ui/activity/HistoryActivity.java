...
public class HistoryActivity extends AppCompatActivity {
    ...
    private void initRefreshLayout() {
        ...
        mAdapter = new ThingApdapter(HistoryActivity.this, thingEntities);
                ...
                if (e==null) {
                    if (list.size()>0) {
                        ...
                        for (ThingEntity td : list) {
                            if (td.getAuthor().getUser_name()
                                    .equals(BmobUser.getCurrentUser(UserEntity.class).getUser_name())) {
                        ...
                        Toast.makeText(HistoryActivity.this,"没有更多了", Toast.LENGTH_LONG).show();
                        mRefreshLayout.setLoading(false); // 结束旋转ProgressBar
                    }
                    else if (actionType == STATE_REFRESH) {
                        Toast.makeText(HistoryActivity.this,"没有数据", Toast.LENGTH_LONG).show();
                    }
                    loading = false;
                    ...
                    Toast.makeText(HistoryActivity.this,"请求异常，请稍后重试：" + e.toString(), Toast.LENGTH_LONG).show();
                    loading = false;
