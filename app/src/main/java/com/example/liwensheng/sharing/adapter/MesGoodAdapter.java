...
public class MesGoodAdapter extends BaseAdapter {
    private Context context;
    private List<GoodEntity> list;
    private ViewHodler holder;
    private LayoutInflater inflater;

    public  MesGoodAdapter(Context context, List<GoodEntity> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.mes_good_item, null);
        ...
        GoodEntity goodEntity = list.get(position);
